...
public class AnalyzeCataloguePrompt {
    ...
    Output format:
    The final output should be a JSON structure representing the documentation hierarchy. Use the following format, the <documentation_structure> </documentation_structure> tag is required:
